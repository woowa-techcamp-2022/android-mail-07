...
class MailRepository {
    fun getPrimaryMails() : List<Mail> {
        return listOf(Mail(1,"GOOGLE", "보안 알림", "Android에서 새로 로그인 abc@gmail로 로그인하였습니다. Android","20220705", PRIMARY),
        Mail(2,"David", "Let's Connect!", "Dear Ivy, We are seeking senior software engineer. Please, contact me.","20220705", PRIMARY),
        Mail(3,"구자경", "안녕하세요, 긴급 요청건으로 연락드립니다. 긴급 요청건으로 연락드리오니 메일 부탁드립니다.", "첨부한 파일 확인 부탁드립니다.","20220705", PRIMARY),
        Mail(4,"크롱", "초대장 : 우아한 테크캠프 수업 - 2022년 7월", "다음 일정에 초대되었습니다. 우아한 테크캠프 수업 - 2022년 7월에 초대되었습니다.","20220705", PRIMARY),
